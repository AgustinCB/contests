...
def find_possible_combinations(square_limits: ((int, int), (int, int)), possible_xs: List[int], possible_ys: List[int]) -> int:
    combinations = []
    for possible_x in possible_xs:
        for possible_y in possible_ys:
            if does_velocity_passes_through_square(square_limits, possible_y, possible_x):
                combinations.append((possible_x, possible_y))
...
def solve():
    ...
    return find_possible_combinations(square_limits, possible_xs, possible_ys)
